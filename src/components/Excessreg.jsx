...
const URL_REGISTROEXC = "http://localhost:3001/api/v1/excess";
...
export default function Excessreg() {
  ...
  const respuestaJson= await enviarData(URL_REGISTROEXC,data);
    ...
    <>
      <div className="d-flex row">
        ...
        <div className='Contenidodollar'>
          <h4 className='tituloh4' >Excess 410/420</h4>
          <div className='row'>
            ...
            <div className='col-md-6 pt-4'>
              <select ref={amount} className="form-select form-select-lg mb-3 btn btn-primary" aria-label=".form-select-lg example">
