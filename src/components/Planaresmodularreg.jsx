...
const URL_REGISTROPLAN = "http://localhost:3001/api/v1/planares-modulars";
...
export default function Planaresmodularreg() {
  ...
  const sap = useRef(null);
  const count = useRef(null);
  const difference = useRef(null);
  const costs = useRef(null);
  ...
  const respuestaJson= await enviarData(URL_REGISTROPLAN,data);
    ...
    <>
      <div className="d-flex row">
        ...
        <div className='Contenidodollar'>
          <h4 className='tituloh4' >Planares Modular</h4>
          <div className='row'>
            ...
            <div className='col-md-6 pt-4'>
              <select ref={sap} className="form-select form-select-lg mb-3 btn btn-primary" aria-label=".form-select-lg example">
