...
export default function Whrepairchangetargetmb() {
  ...
  return (
    ...
    <>
      <div className="d-flex row">
        ...
        <h4 className='tituloh4'>Target WH Repair MB</h4>
        <a href='/register-options/Whrepairchangetarget'><buttom className='btn btn-primary'>LCD</buttom></a>&nbsp;&nbsp;
        <a href='/register-options/Whrepairchangetargetmb'><buttom className='btn btn-primary'>MB</buttom></a>
