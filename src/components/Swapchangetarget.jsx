  ...
  return (
    ...
    <>
      <div className="d-flex row">
        ...
        <h4 className='tituloh4' >Inventory Target Change NB</h4>
        <a href='/register-options/swapchangetarget'><buttom className='btn btn-primary'>NB</buttom></a>&nbsp;&nbsp;
        <a href='/register-options/swapchangetargetdt'><buttom className='btn btn-primary'>DT</buttom></a>
