...
export default function Whrepairtarget() {
  ...
  return (
    ...
    <>
      <div className="d-flex row">
        ...
        <h4 className='tituloh4' >Wh Repair LCD</h4>
        <a href='/options-grafics/whrepairtarget'><buttom className='btn btn-primary'>LCD</buttom></a>&nbsp;&nbsp;
        <a href='/options-grafics/whrepairtargetmb'><buttom className='btn btn-primary'>MB</buttom></a>
