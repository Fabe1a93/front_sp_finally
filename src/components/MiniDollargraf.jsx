              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Cycle Count DT / 100%</th>
                    <th scope="col">Manual Pull DT / 100%</th>
                    <th scope="col">Cycle Count NB / 100%</th>
                    <th scope="col">Manual Pull NB / 100%</th>
                    <th scope="col">Return Const DT - NB 100%</th>
                    <th scope="col">Rebalance DT - NB / 100%</th>
