...
export default function Swapchangetargetgrafntb() {
  ...
  return (
    ...
    <>
      <div className="d-flex row">
        ...
        <h4 className='tituloh4' >Swap Inventory Notebook</h4>
        <a href='/options-grafics/swapchangetarget'><buttom className='btn btn-primary'>Desktop</buttom></a>&nbsp;&nbsp;
        <a href='/options-grafics/swapchangetargetdt'><buttom className='btn btn-primary'>Notebook</buttom></a>
